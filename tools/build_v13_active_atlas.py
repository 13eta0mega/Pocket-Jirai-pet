...
sources={5:Image.open(ROOT/'src/Jirai_Character_Parts5.png').convert('RGBA'),6:Image.open(ROOT/'src/Jirai_Character_Parts6.png').convert('RGBA')}
...
cfg['version']='1.3.0-active72-layered-viseme7'
cfg['sheets']={'atlas':'src/Jirai_Character_Active72_V13.png'}
...
lo['faceShadowLeft']={'center':[225,298],'scale':.42};lo['faceShadowRight']={'center':[375,298],'scale':.42}
lo['blushSoftLeft']={'center':[225,299],'scale':.55};lo['blushSoftRight']={'center':[375,299],'scale':.55}
lo['blushStripeLeft']={'center':[225,300],'scale':.52};lo['blushStripeRight']={'center':[375,300],'scale':.52}
lo['armComposite']={
...
lo['legPoses']={'bentLeft':{'legCenter':[232,672],'legScale':.96,'legAngle':-10,'shoeCenter':[208,792],'shoeAngle':-15}}
...
out_atlas=ROOT/'src/Jirai_Character_Active72_V13.png';atlas.save(out_atlas,optimize=True,compress_level=9)
...
validation={'version':cfg['version'],'parts':len(cfg['parts']),'baseParts':58,'promotedParts':len(new_parts),'atlasSize':[WIDTH,height],'atlasBytes':out_atlas.stat().st_size,'sha256':sha,'lipVisemes':len(cfg['lipSync']['viseme_ids']),'browProfiles':len(cfg['browProfiles']),'appendOnlyBaseCoordinates':True}
